...
export default function Header() {
    ...
    return (
        <header className="flex h-18 w-full flex-row items-center justify-between bg-white dark:white relative z-10 shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
                <div className="flex flex-row items-center justify-start ml-10">
                ...
                <div className="flex flex-row items-center justify-end mr-20">
                    ...
                    <Link href="/products" className={`text-sm ${pathname === '/products' ?  'text-blue-500' : 'text-gray-500'} font-bold mr-6 hover:text-blue-500`}>Products</Link>
